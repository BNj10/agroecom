...
import DashboardTable, { type DashboardTableRef, type RentalStatus } from "@/components/DashboardTable"
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-poppins p-4 md:p-6">
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
          <div>
            ...
            <p className="text-gray-600">Manage and review all rental requests</p>
          </div>
      ...
      <RentalsFilter
        ...
        searchPlaceholder="Search rentals by name, email, or equipment..."
      />
